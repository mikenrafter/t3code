...
const makeWsRpcLayer = (
  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      const liveQuota = yield* LiveQuotaService.LiveQuotaService;
      ...
      return WsRpcGroup.of({
        ...
        [WS_METHODS.serverGetLiveQuota]: (_input) =>
          observeRpcEffect(WS_METHODS.serverGetLiveQuota, liveQuota.readSnapshots, {
            "rpc.aggregate": "server",
          }),
