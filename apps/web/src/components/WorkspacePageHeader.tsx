...
export function WorkspacePageHeader({
  ...
  return (
    <header
      className={cn(
        "flex h-[var(--workspace-topbar-height)] min-h-[var(--workspace-topbar-height)] shrink-0 items-center gap-3 pl-[calc(env(safe-area-inset-left)+0.75rem)] pr-[calc(env(safe-area-inset-right)+0.75rem)] [[data-panel-animations=true]_&]:motion-safe:transition-[padding-left,padding-right] [[data-panel-animations=true]_&]:motion-safe:[transition-duration:var(--panel-animation-duration)] [[data-panel-animations=true]_&]:motion-safe:ease-out max-[980px]:min-h-[var(--workspace-topbar-height)] max-[980px]:h-auto max-[980px]:flex-col max-[980px]:items-stretch max-[980px]:gap-4 max-[980px]:pl-[calc(env(safe-area-inset-left)+0.975rem)] max-[980px]:pr-[calc(env(safe-area-inset-right)+0.975rem)] sm:pl-[calc(env(safe-area-inset-left)+1.25rem)] sm:pr-[calc(env(safe-area-inset-right)+1.25rem)]",
